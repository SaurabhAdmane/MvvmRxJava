...
import com.saurabh.synerzipdemo.navigation.NavigationAnimation.Companion.RIGHT_TO_LEFT
import com.saurabh.synerzipdemo.utils.extension.isValidString
...
//        TMWPayShortcutManager().removeAllShortcuts()
        ...
        Thread { Glide.get(SynerzipApp.context).clearDiskCache() }.start()
